		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Adhoc WT",
									"targetURL": "#comappadhocwt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappadhocwt-display": {
								"semanticObject": "comappadhocwt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.adhocwt",
									"url": sap.ui.require.toUrl("com/app/adhocwt")
								}
							}
						}
					}
